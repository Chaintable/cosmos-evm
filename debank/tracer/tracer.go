...
func BuildHooks(tracer *CallTracer) *tracers.Tracer {
...
func (t *CallTracer) OnTxStart(vm *tracing.VMContext, tx *ethtypes.Transaction, from common.Address) {
	t.gasLimit = tx.Gas()
}
...
func (t *CallTracer) FinalizeTransaction(from common.Address, tx *ethtypes.Transaction, baseFee *big.Int, res *types.MsgEthereumTxResponse) {
